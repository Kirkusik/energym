...
if (compareCards) {
    const firstCardImg = compareCards.querySelector(
        ".compare-cards__link--first img"
    );
    const secondCardImg = compareCards.querySelector(
        ".compare-cards__link--second img"
    );
    let cardId;
    ...
    function changeCardImg(cardId, event) {
        if (cardId === 1) {
            ...
            document
                .querySelector(".compare-cards__btn")
                .classList.add("invisible");
            document
                .querySelector(".compare-cards__second-pic")
